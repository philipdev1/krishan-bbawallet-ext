...
export function RecentActivity() {
  ...
  const activeBbaWallet = useActiveBbaWallet();
  ...
  const recentBbaTransactions = activeBbaWallet
    ? useRecentBbaTransactions({
        address: activeBbaWallet.publicKey,
      })
    : [];
