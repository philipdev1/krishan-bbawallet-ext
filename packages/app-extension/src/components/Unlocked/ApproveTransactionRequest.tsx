...
const pluginRpcBlockchainMap = {
  ...
  // [PLUGIN_REQUEST_BBA_SIGN_MESSAGE]: Blockchain.BBA,
  // [PLUGIN_REQUEST_BBA_SIGN_TRANSACTION]: Blockchain.BBA,
  // [PLUGIN_REQUEST_BBA_SIGN_ALL_TRANSACTIONS]: Blockchain.BBA,
  // [PLUGIN_REQUEST_BBA_SIGN_AND_SEND_TRANSACTION]: Blockchain.BBA,
};
